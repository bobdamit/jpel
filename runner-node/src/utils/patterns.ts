...
export const ENV_VAR_PATTERN = /env:([A-Za-z0-9_-]+)/g;
...
export default { ACTIVITY_VAR_PATTERN, ACTIVITY_FIELD_PATTERN, ACTIVITY_PROP_PATTERN, PROCESS_VAR_PATTERN, ENV_VAR_PATTERN, mapVariablesArray };
